...
<html lang="en" ng-app="kmApp">
	<head>
		...
		<!-- @if production=false -->
		<script src="js/angular/1.2.23/angular.js"></script>
		<script src="js/angular/1.2.23/angular-ui-router.js"></script>
		<script src="js/angular/1.2.23/angular-resource.js"></script>
		<script src="js/angular/1.2.23/angular-animate.js"></script>
		...
		<script src="js/other/loading-bar.js"></script>
